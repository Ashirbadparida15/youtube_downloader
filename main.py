...
# gui coding
window = Tk()
window.title("Ashirbad Youtube downloader")

# making url field
urlField = Entry(window, font=font, justify=CENTER)
urlField.pack(side=TOP, fill=X, padx=10)
urlField.focus()
# download btn
downloadBtn = Button(window, text="Download Video", font=font, relief='ridge', command=btnClicked)
